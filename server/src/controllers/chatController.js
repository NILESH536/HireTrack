...
exports.sendMessage = asyncHandler(async (req, res) => {
  ...
  return responseBuilder.success(res, { reply }, 'Message sent successfully');
});
...
exports.getHistory = asyncHandler(async (req, res) => {
  ...
  return responseBuilder.success(res, messages, 'Chat history fetched successfully');
});
...
exports.clearHistory = asyncHandler(async (req, res) => {
  ...
  return responseBuilder.success(res, null, 'Chat history cleared');
});
