            ...
            <div className="relative z-10">
              ...
              <div className="flex gap-4 mt-6">
                <button 
                  ...
                  className="px-6 py-2.5 bg-electric text-white rounded-xl font-semibold shadow-lg shadow-electric/20 hover:shadow-electric/40 transition-all hover:-translate-y-0.5"
                >
                  Take Mock Interview
                </button>
                <button 
                  onClick={() => window.location.href = '/student/roadmap'}
                  className="px-6 py-2.5 bg-navy-800 border border-white/10 text-white rounded-xl font-semibold hover:bg-white/5 transition-all hover:-translate-y-0.5"
                >
